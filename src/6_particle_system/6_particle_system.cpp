...
private:
    ...
    void create_graphic_pipeline() {
        ...
        std::vector<char> vert_code = read_shader_file("./src/6_particle_system/shaders/6_particle_system_vert.spv");
        std::vector<char> frag_code = read_shader_file("./src/6_particle_system/shaders/6_particle_system_frag.spv");
    ...
    void create_compute_descriptor_set_layout() {
        ...
        std::array<vk::DescriptorSetLayoutBinding, 3uz> descriptor_set_layout_bindings = {
    ...
    void create_compute_pipeline() {
        std::vector<char> comp_code = read_shader_file("./src/6_particle_system/shaders/6_particle_system_comp.spv");
    ...
    void create_compute_descriptor_sets() {
        ...
        for (std::size_t i { 0uz }; i < MAX_FRAMES_IN_FLIGHT; ++i) {
            ...
            std::array<vk::WriteDescriptorSet, 3uz> write_descriptor_sets = {
    ...
    void record_compute_command_buffer(vk::CommandBuffer commandBuffer) {
        ...
        commandBuffer.dispatch(PARTICLE_COUNT / 256u, 1u, 1u);
        commandBuffer.end(); // command buffer end
    }
};
