...
private:
    ...
    void create_graphic_pipeline() {
        ...
        std::vector<char> vert_code = read_shader_file("./src/3_recreate_swapchain/shaders/3_recreate_swapchain_vert.spv");
        std::vector<char> frag_code = read_shader_file("./src/3_recreate_swapchain/shaders/3_recreate_swapchain_frag.spv");
